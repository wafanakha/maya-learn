...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Des 2024 pada 05.09
...
--
-- Struktur dari tabel `course_attender`
--

CREATE TABLE `course_attender` (
  `ca_id` int(11) NOT NULL,
  `tanggal_join` int(11) NOT NULL,
...
--
-- Indeks untuk tabel `course_attender`
--
ALTER TABLE `course_attender`
...
--
-- AUTO_INCREMENT untuk tabel `course_attender`
--
ALTER TABLE `course_attender`
...
--
-- Ketidakleluasaan untuk tabel `course_attender`
--
ALTER TABLE `course_attender`
  ADD CONSTRAINT `course_attender_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
  ADD CONSTRAINT `course_attender_ibfk_2` FOREIGN KEY (`lesson_id`) REFERENCES `tutorial` (`lesson_id`);
